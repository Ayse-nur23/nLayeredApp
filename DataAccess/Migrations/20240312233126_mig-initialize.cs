...
{
    /// <inheritdoc />
    public partial class miginitialize : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_FileUploads_FileUploadId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("ec8efefc-bbc4-4737-bc3d-e0f4bdb745e3"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "admin", null });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_FileUploadId",
                table: "Products",
                column: "FileUploadId");

            migrationBuilder.CreateIndex(
                name: "UK_Products_ProductName",
                table: "Products",
                column: "ProductName",
                unique: true);
